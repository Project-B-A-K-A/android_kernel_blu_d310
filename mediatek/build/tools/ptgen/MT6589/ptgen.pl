...
my $CUST_PART_TABLE_FILENAME   = "mediatek/config/$PROJECT/partition_table_${PLATFORM}.xls"; # excel file name
...
if (-e $CUST_PART_TABLE_FILENAME){
	$PART_TABLE_FILENAME = $CUST_PART_TABLE_FILENAME;
}
