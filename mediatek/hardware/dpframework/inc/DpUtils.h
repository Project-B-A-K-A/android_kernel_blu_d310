...
public:
    ...
    static const DpFRegistry* Head() { return gHead; }

    const DpFRegistry* next() const { return fChain; }
...
public:
    ...
    ListPtr(const ListPtr<T>& src) {      // copy-constructor
        prep();
