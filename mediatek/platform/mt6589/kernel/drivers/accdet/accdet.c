...
void inline disable_accdet(void)
{
   ...
   //del huruilong ALPS00531864 begin 20130410
	//mutex_lock(&accdet_eint_irq_sync_mutex);
   //del huruilong ALPS00531864 end
	clear_accdet_interrupt();
	udelay(200);
   //add huruilong ALPS00531864 begin
	mutex_lock(&accdet_eint_irq_sync_mutex);
   //add huruilong ALPS00531864 end
...
{ 
   ...
   //del huruilong ALPS00531864 begin
