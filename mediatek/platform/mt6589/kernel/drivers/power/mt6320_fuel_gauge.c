...
kal_int32 gFG_booting_counter_I_FLAG = 0;// MDWLYBLU-932 pengjinlong close fuel gauge
...
//4. update DOD0 after booting Xs
	...
	gFG_capacity = gFG_capacity_by_v;	
     ...
     //   bat_volt_check_point = gFG_capacity; // MDWLYBLU-932 pengjinlong close fuel gauge
