...
# Generated at 2013-02-21 10:48:02
...
#Start ====Allen  
ifeq ($(strip $(RF_GSM_BAND)),RF_GSM_QUAD)
	BAND_SUPPORT = QUAD
else
	ifeq ($(strip $(RF_GSM_BAND)),RF_GSM_DUAL900)
		BAND_SUPPORT = DUAL900
	endif
endif

$(info RF_GSM_BAND====:$(RF_GSM_BAND))
$(info BAND_SUPPORT====:$(BAND_SUPPORT))
#end ====Allen
  # Description:
...
# ------------------------------ Verno information
#VERNO = MOLY.WR8.W1248.MD.WG.MP.V6.P14
VERNO = MD501_A1A_V0.0.1_S1212
BUILD = BUILD_NO
...
BOARD_VER = RATECH89_WE_RGK_JB2_MD1_BB
  # Description:
...
# modified by yaopeng , BUG_ID:MDWLY-19 , 20130304 , modified network by MTK
CUSTOM_OPTION += __EPSK_TX_SW_SWITCH_OFF__

# internal configuration
PROJECT_MAKEFILE_EXT = RATECH89_WE_RGK_JB2_MD1_HSPA_EXT
