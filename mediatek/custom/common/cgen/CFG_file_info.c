...
FileName aBackupToBinRegion[]=
{
	...
	{"Test_Nv_Table", AP_CFG_RDCL_FILE_TEST_NV_LID },
...
{
	 // { AP_CFG_RDCL_FILE_TEST_NV_LID, 0, 	1024 * 1024 },
	  { AP_CFG_REEB_PRODUCT_INFO_LID, 0, 	1024 * 1024 },
	//{ AP_CFG_RDCL_FILE_TEST_NV_LID,  1024*1024 , 1024*1024 }, 	//silongjun  add for MDWLYBLU-999  20130329 
