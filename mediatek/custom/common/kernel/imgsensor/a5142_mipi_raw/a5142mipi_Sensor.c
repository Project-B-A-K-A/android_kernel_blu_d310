...
{
    SENSORDB("lilonghui image_mirror = %d\n", image_mirror);
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    switch(ScenarioId)
    {
        ...
        break;
        case MSDK_SCENARIO_ID_MODULE_ID:
                ...
                pSensorInfo->Camera_Module_ID = mt_get_gpio_in(GPIO133);
                printk("XXXXXXXX AR0543 module ID == %d XXXXXXXXXXXXXXXXXX\n", pSensorInfo->Camera_Module_ID);
