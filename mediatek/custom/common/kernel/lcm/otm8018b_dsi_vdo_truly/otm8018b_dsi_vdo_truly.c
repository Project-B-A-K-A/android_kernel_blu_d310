...
1. lidong.zhou@ragentek.com    2013.4.7
   Description: add mipi  truly otm8018b
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	*/
	...
	{0x00,1,{0x81}},
	{0xC1,1,{0x44}},		//0X66 20130305

	{0x00,1,{0xA1}},		//SSD2805_Gen_write_1A_1P(0x00,0x81);
	{0xC1,1,{0x08}},		//SSD2805_Gen_write_1A_1P(0xC1,0x66);			     //OSC Adj=65Hz

	{0x00,1,{0x80}},		//add 18.03
	{0xC4,1,{0x30}},

	{0x00,1,{0x89}},		//SSD2805_Gen_write_1A_1P(0x00,0xa3);
	{0xC4,1,{0x08}},		//SSD2805_Gen_write_1A_1P(0xc0,0x1B);			     //source pch

	{0x00,1,{0xA2}},		//SSD2805_Gen_write_1A_1P(0x00,0x82);
	{0xC0,3,{0x1B,0x00,0x02}},		//SSD2805_Gen_write_1A_1P(0xc5,0x83);			     //REG-Pump23 AVEE VCL
