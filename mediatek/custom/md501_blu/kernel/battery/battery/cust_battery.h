...
#define BATTERY_OVER_TEMP 3//pengjinlong add for re-charging
...
/* Precise Tunning */
#define BATTERY_AVERAGE_SIZE 	100
//#define BATTERY_AVERAGE_SIZE   3

/* Common setting */
#define R_CURRENT_SENSE 22				// 0.2 Ohm //pengjinlong change this to0.2 >  0.22Ohm
...
#define BAT_NTC_10 1 //Enable by Allen 
#define BAT_NTC_47 0
