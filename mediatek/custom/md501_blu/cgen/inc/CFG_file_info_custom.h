...
#include "../cfgfileinc/CFG_Custom_NvItem.h"			
#include "../cfgdefault/CFG_Custom_NvDefault.h"
...
//silongjun  add for MDWLYBLU-999  20130329 (begin)
	...
	{ "/data/nvram/APCFG/APRDCL/Test_Nv_Table",   VER(AP_CFG_RDCL_FILE_TEST_NV_LID), CFG_FILE_TEST_NV_SIZE,
            CFG_FILE_TEST_NV_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&test_nv_default, DataReset , NULL
        },
