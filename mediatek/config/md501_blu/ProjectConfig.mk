...
# Modify by lijiawu 2013.3.8[start]
#BOOT_LOGO = fwvga
BOOT_LOGO = md501blu
# Modify by lijiawu 2013.3.8[end]
BUILD_CTS=no
BUILD_KERNEL=yes
BUILD_LK=yes
BUILD_MTK_SDK=
BUILD_PRELOADER=yes
BUILD_UBOOT=no
CUSTOM_BUILD_VERNO=BLU-D310a-V01-GENERIC-20131219
CUSTOM_INTERNAL_BUILD_VERNO=MD501_BLU_A1A_V0.4.0_S1219
...
#lilonghui add it for the camera of ov5647 2013-2-17
CUSTOM_HAL_IMGSENSOR =  ov5647_mipi_raw gc0329_yuv#s5k8aayx_mipi_yuv 
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR = kxtikkxtik
CUSTOM_HAL_SUB_BACKUP_LENS=dummy_lens
CUSTOM_HAL_SUB_IMGSENSOR = gc0329_yuv# s5k8aayx_mipi_yuv
CUSTOM_HAL_SUB_LENS=dummy_lens
CUSTOM_KERNEL_ACCELEROMETER = kxtik1004  #Wangkunpeng
...
#lilonghui add it for the camera of ov5647 2013-2-17
CUSTOM_KERNEL_IMGSENSOR =  ov5647_mipi_raw gc0329_yuv# s5k8aayx_mipi_yuv ov5647_mipi_raw
CUSTOM_KERNEL_KPD=kpd
CUSTOM_KERNEL_LCM = nt35590_hd720_dsi_vdo_truly ssd2075_hd720_dsi_vdo_truly otm8018b_dsi_vdo_djn otm8018b_dsi_vdo_truly
...
#Allen USing pmic spk PA
CUSTOM_KERNEL_SOUND=amp_6320pmic_spk
CUSTOM_KERNEL_SSW=ssw_generic
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR=
CUSTOM_KERNEL_SUB_BACKUP_LENS=dummy_lens
CUSTOM_KERNEL_SUB_IMGSENSOR = gc0329_yuv#s5k8aayx_mipi_yuv
CUSTOM_KERNEL_SUB_LENS=dummy_lens
CUSTOM_KERNEL_TOUCHPANEL=GT9XX #cy8ctma300 GT818B-fpga
CUSTOM_KERNEL_USB=mt6577
CUSTOM_KERNEL_VIBRATOR=vibrator
CUSTOM_LK_LCM = nt35590_hd720_dsi_vdo_truly ssd2075_hd720_dsi_vdo_truly otm8018b_dsi_vdo_djn otm8018b_dsi_vdo_truly
CUSTOM_MODEM=md501_a1a_ssim_hspa
CUSTOM_PRELOADER_CUSTOM=custom
CUSTOM_SEC_AUTH_SUPPORT=no
CUSTOM_SEC_SIGNTOOL_SUPPORT=no
CUSTOM_UBOOT_LCM = nt35590_hd720_dsi_vdo_truly ssd2075_hd720_dsi_vdo_truly otm8018b_dsi_vdo_djn otm8018b_dsi_vdo_truly
...
LCM_HEIGHT = 854 #1280 #800
LCM_WIDTH = 480 #720 #480
...
MTK_PRECAPTURE_AF_SUPPORT=yes
# modify by yaopeng, for MD501_blu 20130701 (START)
...
MTK_PRODUCT_LOCALES=en_US zh_CN es_ES pt_BR pt_PT nl_NL fr_FR de_DE hu_HU cs_CZ ar_EG pl_PL fa_IR ldpi xhdpi hdpi mdpi hdpi
# modify by yaopeng, for MD501_blu 20130701 (END)
...
#delete BUG_ID:MDWLYBLU-377 xiawei 20130319(start)
...
#delete BUG_ID:MDWLYBLU-377 xiawei 20130319(end)
...
#modify BUG_id = MDWLYBLU-399 for FWVGA device jinhaijian
RESOURCE_OVERLAY_SUPPORT=generic FWVGA
#end modify BUG_id = MDWLYBLU-399 for FWVGA device
TARGET_ARCH_VARIANT=armv7-a-neon
USE_OPENGL_RENDERER=true
WIFI_WEP_KEY_ID_SET=no
WIFI_WPS_PIN_FROM_AP=no
#add BUG_id =MDWLYBLU-71 yb 20130312(start)
MTK_IP_DIAL = no
#add BUG_id =MDWLYBLU-71 yb 20130312(end)
#add BUG_id =MDWLYBLU-71 yb 20130322(start)
RGK_IS_WIFISOUND =yes
#this is wifi notify sound feature
#add BUG_id =MDWLYBLU-71 yb 20130322(end)
# reefjiang add for memory select 20130417
# Add by guofu.niu for reboot function, 2013-05-22 [start]
RGK_GLOBAL_SHOW_REBOOT=yes
# Add by guofu.niu for reboot function, 2013-05-22 [end]
RGK_MEM_COMBO=yes
